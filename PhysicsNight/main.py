...
### treasure ###
	def treasure(self):
		...
		self.teasure_text = Label(halign = 'center', font_size = 100, text = 'Please input your answer', color = get_color_from_hex('#000000'), markup = True, text_size = (self.box.width, None))
